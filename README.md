# Atlantic Salmon Migration Simulator (v1.8)
...
| AI | `src/ai/*` | Sense → duty-cycled migrate/hold (**v1.8** hold-residency); mid-column cruise; anticipatory avoidance; lie residency; **v1.6 metabolism** |
